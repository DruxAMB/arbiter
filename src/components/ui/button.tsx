...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-accent aria-invalid:ring-3 aria-invalid:ring-accent/20 dark:aria-invalid:border-accent/50 dark:aria-invalid:ring-accent/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border border-accent bg-transparent text-accent hover:bg-accent/10 aria-expanded:bg-accent/10",
        ghost:
          "hover:bg-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:hover:bg-muted/50",
        destructive:
          "bg-accent/10 text-accent hover:bg-accent/20 focus-visible:border-accent/40 focus-visible:ring-accent/20 dark:bg-accent/20 dark:hover:bg-accent/30 dark:focus-visible:ring-accent/40",
